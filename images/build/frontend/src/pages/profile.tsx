				...
				<div id="top-dashboard">
					<div id="bio-container">
						...
						<article id="main-stats">
							<MainStat title={t('profile.total')} stat={90000} />
							<MainStat title={t('profile.victories')} stat={90000} />
					...
					<div id="stats">
						...
						<div className="winratio__stats">
							...
							<div className="stat__display">
								<StatDisplay title={t('profile.wins')} stat={90000} />
							</div>
							<div className="stat__display">
								<StatDisplay title={t('profile.loss')} stat={90000} />
							</div>
						</div>
						<div className="stat__display">
							<StatDisplay title={t('profile.rank')} stat={90000} />
						</div>
						<div className="stat__display">
							<StatDisplay title={t('profile.aces')} stat={90000} />
						</div>
