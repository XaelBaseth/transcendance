...
const PongGame = () => {
	...
	return (<>
		<div className="controls">
			{gameState === "initial" && <button className="button-start" onClick={startGame}>Start</button>}
			{gameState === "running" && <button className="button-start" onClick={pauseGame}>Pause</button>}
		</div>
		<div className="controls">
